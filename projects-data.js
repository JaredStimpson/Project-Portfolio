...
window.portfolioProjects = [
  ...
  },
  {
    ...
    tag: "Machining / CNC / Fixture Design",
    description:
      "High-fidelity wax seal stamps using custom fixturing, CNC milling, and repeatable small-part workholding.",
    story:
    ...
    role: "Design, CAM Toolpath Optimization, Manufacturing, Testing",
    tools: ["Mastercam, Solidworks, HAAS VF-2 Vertical Mill, Soft-jaws, 3D Printing, Standard Parts"],
    timeline: "Fall 2025 - Winter 2026",
    outcome: "Succesfully manufactured multiple versions with custom insignias as gifts",
    pageStyle: 1,
    image: "projects/wax-seal-stamps/media/waxStampMacroChau.JPG",
  ...
  },
  {
    ...
    tag: "Personal Tool / CAD / 3D Printing",
    description:
      "An iteratively design and tested 3D-printed doughnut cutter, published to Thingiverse.",
    story:
      "During the 2020 pandemic, my family wanted to make doughnuts at home. At the time I was getting familiar with CAD such as Fusion 360, so I used this problem as a training excercise to improve my CAD abilities and 3D printing capability knowledge. The design process involved rapid-prototyping and testing to find the ideal design for an ergonomic doughnut cutter.",
    role: "Design, CAD, Manufacturing, Testing",
    tools: ["Fusion 360", "3D printer", "Thingiverse"],
    timeline: "April, 2020",
    outcome: "Successfully used to make doughnuts. Published to thingiverse with 500+ downloads.",
    pageStyle: 0,
    image: "",
    detailImage: "",
